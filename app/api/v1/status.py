...
async def status(session: SessionDep, settings: SettingsDep) -> dict:
    ...
    return {
        ...
        "auto_training": {
            ...
            "policy_bootstrap_samples": settings.auto_train_policy_bootstrap_samples,
            "policy_confidence_level": settings.auto_train_policy_confidence_level,
            "minimum_policy_mean_r_lcb": settings.auto_train_min_policy_mean_r_lcb,
