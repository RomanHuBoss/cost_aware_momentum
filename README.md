...
> Версия 1.26.4: экономическая оценка policy и bootstrap-LCB теперь используют полный ряд реально наблюдавшихся hourly decision cohorts. Часы, в которые policy выбрала `NO TRADE`, учитываются как нулевая доходность; inference больше не условна только на выбранных сделках.
