...
> Версия 1.8.30: контрфактическая оценка execution plan больше не использует ценовое движение до создания плана, profit factor считается по отдельным прибыльным и убыточным вкладам, funding timeline обрабатывается без неограниченного цикла, а instrument specs соблюдают point-in-time receipt cutoff.
