...
> Версия 1.8.31: исправлен блокирующий дефект Alembic migration 1.8.30 — revision ID сокращён до совместимого с `alembic_version.version_num VARCHAR(32)` значения `0008_outcome_path_unavailable`; все количественные и fail-closed исправления 1.8.30 сохранены без изменения торговой логики.
