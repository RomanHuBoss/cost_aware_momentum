...
> Версия 1.49.1: исправлена воспроизводимость чистой PostgreSQL-установки и повторного запуска после остановки на Alembic `0006`. Ревизии, пересекающиеся с текущей ORM-схемой, теперь безопасно принимают уже существующие столбцы, индексы, таблицу artifact archive и trigger function без удаления пользовательских данных.
