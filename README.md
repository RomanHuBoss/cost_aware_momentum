...
> Версия 1.35.3: устранён trainer lifecycle deadlock. Неисправимый pending candidate с отсутствующим artifact, неверным SHA-256/horizon или отсутствующим immutable policy binding теперь terminally закрывается до automatic experiment, после чего scheduler в том же цикле переходит к проверке данных и восстановлению active artifact. Recovery обучения разрешено и при fail-closed production artifact loss; inference при этом не открывается.
