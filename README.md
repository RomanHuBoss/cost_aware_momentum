...
> Версия 1.26.7: preregistered experiment evidence включает выровненные почасовые cost-stress пути ×1,5 и ×2. Normal promotion блокируется, если выбранная конфигурация имеет отрицательный terminal capital return хотя бы в одном обязательном stress-сценарии; legacy promotion gate v2 больше не авторизует activation.
