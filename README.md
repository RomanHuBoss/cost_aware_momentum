...
> Версия 1.36.0: зарегистрированные ML-artifacts теперь сохраняются точными неизменяемыми байтами в PostgreSQL и автоматически восстанавливаются при утрате release-local файла. SHA-256, размер и version binding проверяются fail-closed; model quality, activation, EV/RR и risk gates не ослаблены.
