...
> Версия 1.34.1: market-signal direction и unit economics снова точно соответствуют promotion/OOS policy без исторического point-in-time funding forecast. Текущий projected funding не может развернуть LONG/SHORT после activation; он применяется отдельно и консервативно в execution plan и повторно при acceptance.
