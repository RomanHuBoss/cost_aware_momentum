...
> Версия 1.5.0: trainer стал dataset-aware. Он реагирует не только на новые часы, но и на крупный исторический backfill, расширение обучающего universe и изменение покрытия символов. Worker постепенно загружает до 365 дней истории, а auto-activation дополнительно проверяет экономику cost-aware policy на общем holdout.
