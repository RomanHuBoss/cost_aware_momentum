...
> Версия 1.7.12: ручное закрытие сделки сохраняет хронологию фактических fills. Время partial/full close не может быть раньше entry или последнего уже записанного fill; проверка выполняется до изменения qty, P&L, audit и outbox.
