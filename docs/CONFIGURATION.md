...
| `AUTO_TRAIN_RECOVERY_RETRY_MINUTES` | короткий backoff после технической ошибки bootstrap/recovery, когда пригодной обученной модели нет; default 15 минут |
