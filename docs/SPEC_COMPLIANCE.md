...
Версия проекта после коррекции: 1.3.0
...
Версия 1.3.0 исправляет критический разрыв между обучением, registry, runtime и рекомендацией, но не превращает проект в полностью доказанную production-стратегию. Полный walk-forward, исторический стакан, drift-control, counterfactual outcomes и forward evidence остаются отдельными этапами.
