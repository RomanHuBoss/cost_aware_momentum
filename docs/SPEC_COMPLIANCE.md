...
Версия 1.8.16 завершает accept-time проверку исполнимости: свежие per-trade risk, margin, funding, instrument constraints и tick-aligned price geometry валидируются непосредственно перед решением.
