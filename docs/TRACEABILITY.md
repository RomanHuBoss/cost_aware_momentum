...
| Bounded refetch for incomplete exact-candle coverage | `app/services/market_data.py::sync_candles`; `app/workers/runner.py::hourly_market_close_job`, `should_retry_incomplete_coverage` | `tests/unit/test_hourly_candle_retry_2026_07_04.py` |
...
| Minimum policy actionability density and evidence consistency | `app/config.py::Settings`, `app/ml/lifecycle.py::evaluate_quality_gate`, `app/api/v1/status.py` | `tests/unit/test_policy_actionability_density_2026_07_04.py` |
